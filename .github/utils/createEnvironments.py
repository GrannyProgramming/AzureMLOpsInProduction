...
def create_environment_from_json(env_config):
    ...
    # elif existing_env.conda_file == env_config.get('conda_file', '') and existing_env.version == env_config['version'] and env_config['version'].lower() != 'auto':
    ...
    #     return
    # elif existing_env and not existing_env.conda_file:
